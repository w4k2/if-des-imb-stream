...
knorau1 = SEA(base_estimator=StratifiedBagging(base_estimator=KNeighborsClassifier(
    weights='distance'), random_state=42), des="KNORAU1")
knorau2 = SEA(base_estimator=StratifiedBagging(base_estimator=KNeighborsClassifier(
    weights='distance'), random_state=42), des="KNORAU2")
knorae1 = SEA(base_estimator=StratifiedBagging(base_estimator=KNeighborsClassifier(
    weights='distance'), random_state=42), des="KNORAE1")
knorae2 = SEA(base_estimator=StratifiedBagging(base_estimator=KNeighborsClassifier(
    weights='distance'), random_state=42), des="KNORAE2")
...
def worker(i, stream_n):
    ...
    np.save("results/experiment1_KNN/%s" % stream, results)
