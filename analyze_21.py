...
methods = [
["NON-KNORAU2", "ROS-KNORAU2", "B2-KNORAU2", "NON-KNORAE2", "ROS-KNORAE2", "B2-KNORAE2"],
["NON-KNORAU2", "ROS-KNORAU2", "B2-KNORAU2", "NON-KNORAE2", "ROS-KNORAE2", "B2-KNORAE2"],
["NON-KNORAU1", "ROS-KNORAU1", "B2-KNORAU1", "NON-KNORAE2", "ROS-KNORAE2", "B2-KNORAE2"],
["NON-KNORAU1", "ROS-KNORAU1", "B2-KNORAU1", "NON-KNORAE1", "ROS-KNORAE1", "B2-KNORAE1"]
]
label_noises = [
    "0.01",
    "0.03",
...
def plot_runs(
    ...
    plt.tight_layout()
    plt.savefig("plots/experiment21/runs/%s/21_%s_%s_%s.eps" % (what, clfs[j], metrics[i], dependency[k]), bbox_inches='tight', dpi=250)
    plt.close()
...
def plot_radars(
    ...
    plt.savefig("plots/experiment21/radars/%s/21_%s_%s.eps" % (what, classifier_name, parameter_name), bbox_inches='tight', dpi=250)
    plt.close()
