...
colors = [(0, 0, 0), (0.3, 0.8, 0.3), (0.3, 0.8, 0.3), (0, 0, 0), (0, 0, 0), (0, 0, 0.9), (0, 0, 0.9), (0.9, 0, 0), (0.9, 0, 0)]
ls = ["-", "-", "--", "--", ":", "-", "--", "-", "--"]
...
def plot_runs(
    ...
    ax = plt.axes()
    # selected_scores[[1, 3]] = selected_scores[[3, 1]]
    # selected_scores[[2, 4]] = selected_scores[[4, 2]]
    # mean_scores[[1, 3]] = mean_scores[[3, 1]]
    # mean_scores[[2, 4]] = mean_scores[[4, 2]]
    ...
    plt.savefig("plots/experiment5/runs/%s/5_%s_%s_%s.eps" % (what, clfs[j], metrics[i], dependency[k]), bbox_inches='tight', dpi=250, pad_inches=0.0)
    plt.close()
...
def plot_radars(
    ...
    plt.savefig("plots/experiment5/radars/%s/5_%s_%s.eps" % (what, classifier_name, parameter_name), bbox_inches='tight', dpi=250, pad_inches=0.0)
    plt.close()
