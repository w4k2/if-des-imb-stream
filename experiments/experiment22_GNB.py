...
rus_knorau2 = SEA(base_estimator=StratifiedBagging(base_estimator=GaussianNB(
...
rus_knorae2 = SEA(base_estimator=StratifiedBagging(base_estimator=GaussianNB(
...
clfs = (none_knorau2, rus_knorau2, cnn_knorau2, none_knorae2, rus_knorae2, cnn_knorae2)
...
def worker(i, stream_n):
    ...
    np.save("results/experiment22_GNB/%s" % stream, results)
